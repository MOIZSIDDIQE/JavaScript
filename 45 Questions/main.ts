...
//                                                   TASK :36
function Myshirt (size:string,text:string):void{
...
//                                                      TASK :37
function MyShirt(size:string='small',text:string='Avengers'): void{
...
//                                                TASK :39
function call_city(city:string,country:string):string{
    return `"${city}","${country}"`
}
...
//                                                   TASK :40
function My_Album(artist: string, title: string): { artist: string; title: string } {
       const dictionary = {
...
console.log(Album);
                                                 ...
                                                 TASK :41
function Best_Magicians(magicians: string []): void {
...
const magician2:string [] = ["fazal","David Copperfield","Roger Lapin"];
Make_great(magician2)
Best_Magicians(magician2)

//                                             TASK:43
function Make_great2(magicians:string[]):string[] {
       const G_magician:string[] = [];
       for(let m=0; m < magicians.length; m++ ){
       G_magician.push(magicians[m]+' is the professional magician.')
       }return G_magician;
}
const magician3:string[] = ["fazal","David Copperfield","Roger Lapin","moiz"];
const G_magician2:string [] = Make_great2 (magician3);
